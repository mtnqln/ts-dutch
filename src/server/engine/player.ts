...
import { ActivateCard, PlayerChoice, PutToBin } from "./turn";
...
export class Player {
    ...
    constructor(player: string, deck: Deck){
        this.deck = deck;
        this.player = player;
    ...
    playIntermediate(bin: Bin,otherDeck:Deck,putToBin: PutToBin,activateCard?: ActivateCard[]):Card[] | undefined{
    ...
    // Classic play 
    play(stack:Stack, bin: Bin,otherDeck: Deck, choice?: PlayerChoice):Card | undefined{
